...
class FormDescriptorService
{
    ...
    protected string $formBuilderClass;
    ...
    public function __construct(
        ...
        readonly protected FormFactoryInterface $formFactory,
        readonly protected Environment $environment,
        readonly protected RequestStack $requestStack,
        readonly protected MailerInterface $mailer,
    ) {
        ...
        if ($form->isSubmitted()) {
            if ($form->isValid()) {
                ...
                if ($formDescriptor->getRecipients()) {
                    $countryInfo = $this->requestStack->getCurrentRequest()->getSession()->get(UtilsService::COUNTRY_SESSION_KEY);
