...
trait WebCoreAssetTrait
{
    ...
    public function assetDownload(Request $request, $assetCode, $fileName = null)
    {
        ...
        $response->setContentDisposition(
            ResponseHeaderBag::DISPOSITION_ATTACHMENT, $asset->getFileName()
        );
//            $fileName && strpos($fileName, '.') !== false ? $fileName : $asset->getFileName());
...
//            $ext = "jpg";
        ...
        $SAVE_ASSETS_TO_DB = $_ENV['SAVE_ASSETS_TO_DB'];
    ...
    {
        $header = (array)$header;
        return new BinaryFileResponse($file, Response::HTTP_OK, $header);
    }
}
