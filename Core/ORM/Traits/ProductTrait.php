...
trait ProductTrait
{
    ...
    public function objImageUrl()
    {
        ...
        return count($gallery) > 0 ? "/images/assets/{$gallery[0]->getId()}/medium" : "/images/assets/" . $_ENV['PRODUCT_PLACEHOLDER_ID'] ?? null . "/1";
    }
    ...
    public function objImage()
    {
        ...
        if (count($gallery) > 0) {
            ...
            return [
                $_ENV['PRODUCT_PLACEHOLDER_ID'] ?? null,
                1,
            ];
        }
    }
    ...
    public function objThumbnail()
    {
        ...
        if (count($gallery) > 0) {
            ...
            return [
                'id' => $_ENV['PRODUCT_PLACEHOLDER_ID'] ?? null,
                'code' => null,
            ];
        }
    }
