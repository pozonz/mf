...
use MillenniumFalcon\Core\ORM\Generated\Customer;
...
trait CustomerTrait
{
     ...
     * @return array|null
     */
    public function objMembership(): ?CustomerMembership
    {
        if (!$this->membership) {
     ...
     * @return array|null
     */
    public function objAddresses(): ?CustomerAddress
    {
     ...
     * @param array $options
     */
    public function save($doNotSaveVersion = false, $options = []): mixed
    {
